    ...
    <div class="container">
        ...
        <div class="field has-addons">
            <div class="control is-expanded">
                <input id="input-id" class="input is-primary is-large" type="number" :value="togetterId" v-bind:readonly=isLoading @input="setId" @keyup.enter="getText" placeholder="取得したいTogetterのIDを入力してください(https://togetter.com/li/(ID))">
